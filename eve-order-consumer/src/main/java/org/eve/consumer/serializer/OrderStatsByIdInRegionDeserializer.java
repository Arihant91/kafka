...
public class OrderStatsByIdInRegionDeserializer implements Deserializer<OrdersStatsByIdInRegion> {

    private final ObjectMapper objectMapper;

    public OrderStatsByIdInRegionDeserializer() {
    ...
    public OrdersStatsByIdInRegion deserialize(String topic, byte[] data) {
        try {
            ...
            throw new SerializationException("Error deserializing OrdersStatsByIdInRegion", e);
        }
    }
